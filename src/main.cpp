...
uint256 hashGenesisBlock("0x70d875ce2e723fd56923aaeb68ba15a1ce9a556a94d66d7d3cae9d9aefc1a155");
static CBigNum bnProofOfWorkLimit = CBigNum().SetCompact(504365644); // Darkcoin: starting difficulty is 1 / 2^12
...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 840000); // Darkcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 302400; // Darkcoin: 3.5 days
static const int64 nTargetSpacing = 150; // Darkcoin: 2.5 minutes
...
bool LoadBlockIndex()
{
    if (fTestNet)
    {
        ...
        hashGenesisBlock = uint256("0x2f84b36c24f6b117f8c9529bd1ffb41958144fc6b25a1a02d732ed8faddb1fcb");
    }
...
bool InitBlockIndex() {
    ...
    if (!fReindex) {
        ...
        // Genesis block
        const char* pszTimestamp = "17 de febrero 2021 -Inicio de Darkcoin.";
        CTransaction txNew;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        txNew.vin[0].scriptSig = CScript() << 486604799 << CBigNum(4) << vector<unsigned char>((const unsigned char*)pszTimestamp, (const unsigned char*)pszTimestamp + strlen(pszTimestamp));
        txNew.vout[0].nValue = 5000000000;
        txNew.vout[0].scriptPubKey = CScript() << ParseHex("d931ccb70d21eed1c9f21ef9ddc9feaa754790a4282301f6957ced58e7b23c1f9ed127e3649a58dad7777a1f5b4ec70d5833c9fa664a5051620b0abda5da63fb8d") << OP_CHECKSIG;
        CBlock block;
        block.vtx.push_back(txNew);
        block.hashPrevBlock = 0;
        block.hashMerkleRoot = block.BuildMerkleTree();
        block.nVersion = 1;
        block.nTime    = 1613594327;
        block.nBits    = 504365644;
        block.nNonce   = 2820751932;

        if (fTestNet)
        {
            block.nTime    = 1613594327;
            block.nNonce   = 4165453660;
        }
        ...
        assert(block.hashMerkleRoot == uint256("0x6980688f3eb7264507e1af45c2c7fbeb1c8d5692f75bc5ee1b32d7a843e639d4"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xfb, 0xc0, 0xb6, 0xdb }; // Darkcoin: increase each by adding 2 to bitcoin's value.
