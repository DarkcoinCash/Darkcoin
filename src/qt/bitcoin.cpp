...
int main(int argc, char *argv[])
{
    ...
    if (!boost::filesystem::is_directory(GetDataDir(false)))
    {
        ...
        QMessageBox::critical(0, "Darkcoin",
    ...
    QApplication::setOrganizationDomain("darkcoin.org");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        QApplication::setApplicationName("Darkcoin-Qt-testnet");
    else
        QApplication::setApplicationName("Darkcoin-Qt");
